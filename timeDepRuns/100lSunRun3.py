...
st = star.star(x,y,mSun,rSun,100*lSun,1.5,thermcache,rhocache,convcache,lext=100*lSun,caution=500)
eps = st.eps0
t0 = st.state[:,0]
for i in range(20):
...
plt.savefig('Plots/100Lsun_short_subtractive.eps',dpi=200)