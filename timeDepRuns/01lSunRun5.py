...
st = star.star(x,y,0.3*mSun,2.65*rSun,0.1*lSun,1.5,thermcache,rhocache,convcache,lext=10*lSun,caution=500)
eps = st.eps0
t0 = st.state[:,0]
for i in range(20):
...
plt.savefig('Plots/01_10_Lsun_short_subtractive.eps',dpi=200)